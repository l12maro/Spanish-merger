...
The original study consisted on 221 participants who were from the cities from where the audio cues were taken. This replication study does not target one specific location. The exp ected sample size consists of 100 to 200 listeners. The listeners should be nationals of Spain who are native speakers of Peninsular Spanish and have spent more than five years in the town. The study will control for place of residence to ensure a balanced sample between urban and rural participants as well as speakers of both _seseo_ and _ceceo_ dialects.

### Materials

The original study extracted its stimuli from informal sociolinguistic interviews that have been conducted by the author. In the current replication, the stimuli is generated following the criteria of inclusion used in the original experiment. The stimuli contains data from eight speakers, four female spakers and four male speakers.
...
Stimuli are recorded from eight speakers instead of 12, balanced by gender. Speakers are not be from Huelva or Lepe, as in the original study, but from Almonte. Participants may be any speaker of Peninsular Spanish. In this experiment, the guises are performed by the speakers, while the original experiment created them digitally by manipulating the fricative sounds. The control items are extracted from public data.
